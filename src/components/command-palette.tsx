...
const ROUTES: PaletteItem[] = [
  ...
  { id: "ios",        label: "iOS Ops Center",    sub: "iOS 14–18 MDM, jailbreak, WebKit", href: "/ios" },
  { id: "adminsec",   label: "Admin Security",    sub: "Protect Tailscale mesh + proxy",   href: "/admin-security" },
  { id: "counter",    label: "Counter-Intel",     sub: "Kill switch, panic, trace detect", href: "/counter" },
  { id: "firmware",   label: "Firmware Studio",   sub: "Anti-RE hardening for payloads",   href: "/firmware" },
  { id: "embed",      label: "Payload Embedding",  sub: "PDF, video, Office, APK, iOS",   href: "/embed",     keys: "G D" },
  ...
  { id: "setup",      label: "Setup Wizard",      sub: "Network, listener, payload, delivery — step-by-step", href: "/setup", keys: "G S" },
